...
# Magic Genie Program
# genie intro
print("Hello, I am the best genie there is, you have 3 wishes now...")

# get user wishes
Wish1 = input("What is you wish?")
Wish2 = input("What is you wish?")
Wish3 = input("What is you wish?")

# display wishes
print("Your wishes were: " + Wish1 + ", " + Wish2 + ", " + Wish3)
